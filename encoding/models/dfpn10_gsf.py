...
class dfpn10_gsfHead(nn.Module):
    def __init__(self, in_channels, out_channels, norm_layer, se_loss, jpu=False, up_kwargs=None,
        ...
        self.conv52 = nn.Sequential(nn.Conv2d(1024, inter_channels, 3, padding=1, bias=False),
                                   norm_layer(inter_channels),
                                   nn.ReLU(),
                                   )
        ...
        self.localUp3=localUp(inter_channels*2, inter_channels, norm_layer, up_kwargs)
    ...
    def forward(self, c1,c2,c3,c4,c20,c30,c40):
        ...
        p3 = self.dconv3(out34)
        p3 = F.interpolate(p3, (h,w), **self._up_kwargs)
        p2 = self.dconv2(out234)
        p1 = self.dconv1(out234)
...
class localUp(nn.Module):
    ...
    def forward(self, high,low):
        ...
        out = self.connect(torch.cat([high, low], dim=1))
        return out
