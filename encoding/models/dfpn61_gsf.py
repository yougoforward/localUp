...
class dfpn61_gsfHead(nn.Module):
    def __init__(self, in_channels, out_channels, norm_layer, se_loss, jpu=False, up_kwargs=None,
        ...
        self.dconv4_2 = nn.Sequential(nn.Conv2d(in_channels, inter_channels, 3, padding=2, dilation=2, bias=False),
                                   norm_layer(inter_channels),
                                   nn.ReLU(),
                                   )
        self.dconv4_4 = nn.Sequential(nn.Conv2d(in_channels, inter_channels, 3, padding=4, dilation=4, bias=False),
                                   norm_layer(inter_channels),
                                   nn.ReLU(),
                                   )
    ...
    def forward(self, c1,c2,c3,c4,c20,c30,c40):
        ...
        out = self.project(torch.cat([out2,out3,p4_1,p4_2,p4_4,p4_8], dim=1))
